...
- [`src/`](src) — Java practice programs
- [`notes/`](notes) — topic notes, rules, and lessons from mistakes
- [`patterns/`](patterns) — reusable algorithm templates

## Revision Progress

- [x] Arrays fundamentals
- [x] Strings fundamentals
- [x] Java basics and OOP inheritance
